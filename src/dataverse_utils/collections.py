...
class StudyMetadata(dict):
    ...
    '''
    def __init__(self, study_meta:dict, **kwargs) -> None:
        '''
    ...
    def extract_field_metadata(self, field) -> None:
        '''
...
class DvCollection:
    ...
    def __init__(self, url:str, coll:str, key=None, **kwargs) -> None:
        '''
    ...
    def __get_shortname(self, dvid) -> str:
        '''
    ...
    def get_collections(self, coll:str=None, output=None) -> list:
        '''
    ...
    def get_studies(self, root:str=None, **kwargs) -> list:
        '''
    ...
    def get_collection_listing(self, coll_id, **kwargs) -> list:
        '''
    ...
    def get_study_info(self, pid, **kwargs) -> StudyMetadata:
        '''
